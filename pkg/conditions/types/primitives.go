...
//var AnyParamType = NewParameterType("any", cel.AnyType, nil, anyTypeConverterFunc)
//var BoolParamType = NewParameterType("bool", cel.BoolType, nil, primitiveTypeConverterFunc[bool])
//var StringParamType = NewParameterType("string", cel.StringType, nil, primitiveTypeConverterFunc[string])
// var IntParamType = NewParameterType("int", cel.IntType, nil, numericTypeConverterFunc[int64])
// var UIntParamType = NewParameterType("uint", cel.UintType, nil, numericTypeConverterFunc[uint64])
// var DoubleParamType = NewParameterType("double", cel.DoubleType, nil, numericTypeConverterFunc[float64])
// var DurationParamType = NewParameterType("duration", cel.DurationType, nil, durationTypeConverterFunc)
// var TimestampParamType = NewParameterType("timestamp", cel.TimestampType, nil, timestampTypeConverterFunc)

// var MapParamType ParameterType
// var ListParamType ParameterType

// var PrimiviteParamTypes = []ParameterType{
// 	AnyParamType,
// 	BoolParamType,
// 	StringParamType,
// 	IntParamType,
